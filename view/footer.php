...
<script src="<?php echo $path?>assets/js/jquery-3.3.1.min.js"></script>
<script src="<?php echo $path?>assets/js/modernizr-3.6.0.min.js"></script>
<script src="<?php echo $path?>assets/js/plugins.js"></script>
<script src="<?php echo $path?>assets/js/bootstrap.min.js"></script>
<script src="<?php echo $path?>assets/js/heandline.js"></script>
<script src="<?php echo $path?>assets/js/isotope.pkgd.min.js"></script>
<script src="<?php echo $path?>assets/js/magnific-popup.min.js"></script>
<script src="<?php echo $path?>assets/js/owl.carousel.min.js"></script>
<script src="<?php echo $path?>assets/js/wow.min.js"></script>
<script src="<?php echo $path?>assets/js/countdown.min.js"></script>
<script src="<?php echo $path?>assets/js/odometer.min.js"></script>
<script src="<?php echo $path?>assets/js/viewport.jquery.js"></script>
<script src="<?php echo $path?>assets/js/nice-select.js"></script>
