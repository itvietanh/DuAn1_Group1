                                ...
                                <?php
                                    foreach ($list_film as $value) {
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td><?php echo $id_showTimeFrame?></td>
                                            <td><?php echo $image?></td>

                                            <td><a href="index.php?act=add_film"><input type="submit" name="" value="Thêm"></a> | <a href=""><input type="submit" value="Sửa"></a> | <a href=""><input type="submit" value="Xóa"></a></td>
                                        </tr>
                                <?php
                                    }
                                ?>
