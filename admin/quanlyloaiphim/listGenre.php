                ...
                <div id="zero_config_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                            ...
                            <table id="zero_config" class="table table-striped table-bordered dataTable" role="grid" aria-describedby="zero_config_info">
                                ...
                                foreach ($list_genre as $value) {
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td><?php echo $name?></td>
                                        <td><a href="index.php?act=edit_genre&id=<?php echo $id?>"><input type="button" name="btn_edit" value="Sửa"></a> | <a onclick="return confirm('Bạn có muốn xóa loại phim này không?')" href="index.php?act=delete_genre&id=<?php echo $id?>"><input type="button" name="btn_delete" value="Xóa"></a></td>
                                    </tr>
                                    <?php
                                }
                                ?>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-5">
                            <a href="index.php?act=add_genre"><input type="button" name="add_genre" value="Thêm Phim"></a>
                        </div>
